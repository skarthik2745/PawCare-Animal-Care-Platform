...
import logoImage from '../assest/logo.jpeg';
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <img
                src={logoImage}
                alt="PawCare logo"
                className="mx-auto mb-10 w-full max-w-sm sm:max-w-md lg:max-w-lg rounded-2xl border border-cyan-300/40 shadow-[0_0_45px_rgba(0,207,255,0.3)]"
              />
